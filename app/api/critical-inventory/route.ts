...
/**
 * GET /api/critical-inventory - Obtener inventario crítico
...
export async function GET(req: NextRequest) {
    try {
        ...
        const laravelUrl = new URL(`${API_CONFIG.baseURL}/critical-inventory`);
        ...
        if (!response.ok) {
            return NextResponse.json(
                { error: data.message || 'Error al obtener inventario crítico' },
        ...
        console.error('Error en GET /api/critical-inventory:', error);
