...
/**
 * GET /api/top-selling-products - Obtener productos más vendidos
...
export async function GET(req: NextRequest) {
    try {
        ...
        const laravelUrl = new URL(`${API_CONFIG.baseURL}/top-selling-products`);
        ...
        if (!response.ok) {
            return NextResponse.json(
                { error: data.message || 'Error al obtener productos más vendidos' },
        ...
        console.error('Error en GET /api/top-selling-products:', error);
