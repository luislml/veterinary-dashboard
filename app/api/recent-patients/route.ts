...
/**
 * GET /api/recent-patients - Obtener pacientes recientes
...
export async function GET(req: NextRequest) {
    try {
        ...
        const laravelUrl = new URL(`${API_CONFIG.baseURL}/recent-patients`);
        ...
        if (!response.ok) {
            return NextResponse.json(
                { error: data.message || 'Error al obtener pacientes recientes' },
        ...
        console.error('Error en GET /api/recent-patients:', error);
