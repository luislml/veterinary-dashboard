...
/**
 * GET /api/frequent-consultations - Obtener consultas frecuentes
...
export async function GET(req: NextRequest) {
    try {
        ...
        const laravelUrl = new URL(`${API_CONFIG.baseURL}/frequent-consultations`);
        ...
        if (!response.ok) {
            return NextResponse.json(
                { error: data.message || 'Error al obtener consultas frecuentes' },
        ...
        console.error('Error en GET /api/frequent-consultations:', error);
