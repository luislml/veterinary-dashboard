...
/**
 * GET /api/images-veterinaries - Obtener lista de imágenes de veterinarias
...
export async function GET(req: NextRequest) {
    try {
        ...
        const laravelUrl = new URL(`${API_CONFIG.baseURL}/images-veterinaries`);
        ...
        console.error('Error en GET /api/images-veterinaries:', error);
