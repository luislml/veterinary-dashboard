...
/**
 * GET /api/sales-analytics - Obtener analytics de ventas
...
export async function GET(req: NextRequest) {
    try {
        ...
        const laravelUrl = new URL(`${API_CONFIG.baseURL}/sales-analytics`);
        ...
        if (!response.ok) {
            return NextResponse.json(
                { error: data.message || 'Error al obtener analytics de ventas' },
        ...
        console.error('Error en GET /api/sales-analytics:', error);
